...
@Composable
fun ChampionScreen() {
  val viewModel = hiltViewModel<ChampionViewModel>()
...
fun ChampionListScreen(
  ...
  Scaffold(
    modifier =
      Modifier.reportSnackBarPosition<ChampionKey>(SnackBarPosition.BOTTOM)
    ...
    PullRefreshBox(
      ...
      if (!state.showError) {
        ...
        ErrorContent(modifier = Modifier.fillMaxSize(), onRetry = onRetry)
      }
    }
  }
}
