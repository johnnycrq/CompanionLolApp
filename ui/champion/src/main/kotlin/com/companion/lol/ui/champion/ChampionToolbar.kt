...
import com.companion.lol.core.ui.R as CoreUiR
import com.companion.lol.core.ui.material3.companionAppGradientInverted
  ...
  TopAppBar(
    ...
    actions = {
      ...
      DropdownMenu(
        ...
        DropDownMenuItem(
          title = R.string.champion_grid_count,
        ...
        DropDownMenuItem(
          title =
            when (sortOrder) {
              SortOrder.ASC -> R.string.champion_sort_favorites
              SortOrder.FAVORITES -> R.string.champion_sort_alphabetically
            },
          icon =
            when (sortOrder) {
        ...
        DropDownMenuItem(
          title = R.string.champion_clear_favorites,
